...
How my copyright works is VERY simple. Just put (some where on your project/website (it can even be a comment in the HTML/code ok??)) "<code> was sorced from AirplaneGobrr(APGB)"
